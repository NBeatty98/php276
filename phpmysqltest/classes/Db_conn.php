...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'nbeatty';//this will be your WCC username
      $dbUsr = 'nbeatty';//this will be your WCC username
      $dbPass = 'WEKHkJaE4uU2';//this will be the password found in the video.
